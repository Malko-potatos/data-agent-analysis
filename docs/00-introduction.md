...
- 가까운 Codex use case를 찾고 교육용 harness와 연결한다.
...
3. 가까운 Codex use case를 고른다.
4. 교육용 Agent Workflow Harness를 선택한다.
5. 필요한 데이터, 도구, 권한, 스킬을 적는다.
6. 실행 프롬프트를 작업 명세로 쓴다.
7. 검증 기준과 승인 경계를 붙인다.
8. 반복 작업이면 자동화나 skill 후보로 정리한다.
